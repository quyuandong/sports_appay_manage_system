    ...
    <div>
        ...
        <div class="container">
            ...
            >
                ...
                <el-table-column prop="did" align="center" label="专业">
                    <template slot-scope="scope">
...
import { findApplyByApprover, findApplyByTeacherExport } from '../../api/apply';
...
export default {
    ...
    methods: {
        ...
        exportExcel(datas) {
            // 设置Excel的表格第一行的标题
            const tHeader = ['序号', '学号', '姓名','专业','报名项目','报名时间','审核时间'];
            const filterVal = ['index', 'sno', 'name','specialy','title','create_time','update_time'];
            let list = []
            datas.forEach((item,index)=>{
                ...
                params['specialy'] = this.getName(item);
        ...
        getAllApplys() {
            ...
            findApplyByApprover(this.query)
                .then(res => {
                    let data = this.$get(res, 'data', {});
