    ...
    <div>
        ...
        <div class="container">
            ...
            >
                ...
                <el-table-column prop="name" align="center" show-overflow-tooltip label="专业名称">
                ...
                <el-table-column
                    ...
                    label="专业简介"
                ></el-table-column>
                <el-table-column label="是否启用" show-overflow-tooltip min-width="50px" align="center">
                    <template slot-scope="scope">
                        <el-switch
...
<script>
import SpecialtyDialog from './SpecialtyDialog.vue';
import { getSpecialtyList, updateSpecialty, deleteSpecialty } from '../../api/specialty';
